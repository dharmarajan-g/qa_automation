...
public abstract class BasePage extends WebDriverUtil {
    ...
    public void waitForElementAreComplete(By by, int expected) {
        ExpectedCondition<Boolean> angularLoad = driver -> {
            int loadingElements = getDriver().findElements(by).size();
    ...
    public void waitForAnimationToComplete(String css) {
        ExpectedCondition<Boolean> angularLoad = driver -> {
            int loadingElements = getDriver().findElements(By.cssSelector(css)).size();
